// Ashima/Gustavson simplex 3D noise (MIT, stegu/webgl-noise).
// MIRRORED LINE-FOR-LINE in TypeScript at src/scene/simplex.ts — the dissolve
// seams depend on the two implementations agreeing to within ~1e-5.
